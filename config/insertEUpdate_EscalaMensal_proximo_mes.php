...
// echo $retorno." update <br>";
    ...
    $insertDadosNaTabela = $InsertDeDados->insertEscalaMensalProximoMes($oracle, $tabela,$diaSelecionado,  $matricula,$nome,$loja,  $cargoFunc,$mesPesquisado, $horarioEntradaFunc,$horarioSaidaFunc,  $horarioIntervaloFunc, $opcaoSelect, $usuarioLogado,$inclusaoDoMesAnterior,$departamentoFunc);
